...
class NodePiece_Tokenizer:
    ...
    def __init__(self,
        ...
        # well, betweenness is disabled
        self.AVAILABLE_STRATEGIES = set(["degree", "betweenness", "pagerank", "random", "ppr_kmeans", "ppr_agglo", "ppr_kmeans_diff", "ppr_agglo_diff"])
    ...
    def tokenize_kg(self):
        ...
        # creating a filename
        strategy_encoding = f"d{self.anchor_strategy['degree']}_b{self.anchor_strategy['betweenness']}_p{self.anchor_strategy['pagerank']}_r{self.anchor_strategy['random']}_pk{self.anchor_strategy['ppr_kmeans']}_ps{self.anchor_strategy['ppr_agglo']}_pac{self.anchor_strategy['ppr_kmeans_diff']}_paw{self.anchor_strategy['ppr_agglo_diff']}"
        ...
        #print("Graph: ", graph)
        #print("triples: ", self.triples_factory.triples)
        #print("Starting with file \n \n \n")
        #edge_with_relations_list = [[s, r, t] for s, t, r in zip(src, tgt, rels)]  #node 1, relation edge, node 2
        #print(edge_with_relations_list)
        #with open("yago 3-10raw.txt", "w") as datafile:
        #    for triple in edge_with_relations_list:
        #        datafile.write(str(triple)+"\n")
        #print("file should be done :)")
        ...
        for strategy, ratio in self.anchor_strategy.items():
            ...
            elif strategy == "ppr_kmeans":
                with open("/home/diependaal/NodePiece-main/lp_rp/fb/fb-k-means-1000", "rb") as fp: # KGloVe should give a file containing the nodes to pick, change path to this file. 
                    top_nodes = pickle.load(fp)
            elif strategy == "ppr_agglo":
                with open("/home/diependaal/NodePiece-main/lp_rp/fb/fb-agglo-1000", "rb") as fp: # KGloVe should give a file containing the nodes to pick, change path to this file.
                    top_nodes = pickle.load(fp)
            elif strategy == "ppr_kmeans_diff":
                with open("/home/diependaal/NodePiece-main/lp_rp/fb/fb-diff-k-means-1000", "rb") as fp: # KGloVe should give a file containing the nodes to pick, change path to this file.
                    top_nodes = pickle.load(fp)
            elif strategy == "ppr_agglo_diff":
                with open("/home/diependaal/NodePiece-main/lp_rp/fb/fb-diff-agglo-1000", "rb") as fp: # KGloVe should give a file containing the nodes to pick, change path to this file.
                    top_nodes = pickle.load(fp)
